		...
		<div class="box-container">
			...
			<div class="box">
				<form action="PatientRegisterServlet" method="post">
					...
					<span id="errMsg"></span>
					<br>
					<input type="password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="psw" name="password" required onblur="myFunction2()">
					<br><br>
					...
					<br><br>
					<input type="tel" id="mobnumber" placeholder="Enter your Number" name="mobilenumber" maxlength="10" required pattern="[6-9]{1}[0-9]{9}" onblur="myFunction3()" >
...
<%@ include file="footer.jsp" %>
	...
	<script type="text/javascript">
		...
		function myFunction2() {
		  	const inpObj = document.getElementById("psw");
		  	if (!inpObj.checkValidity()) {
		  		...
		  		document.getElementById("submit").disabled=false;
		  		document.getElementById("psw").style.border='2px solid grey';
		  		document.getElementById("submit").style.cursor='pointer';
		  	}
			}
